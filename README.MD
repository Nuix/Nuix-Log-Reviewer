...
This is a [.NET Framework 4.8](https://dotnet.microsoft.com/download/dotnet-framework/net48) application which provides a quick and easy way to parse, index and search Nuix logs files.
